...
export const FOODS = {
  apple:  { id: 'apple',  name: '苹果',   emoji: '🍎', satiety: 20, exp: 10, sellPrice: 4,  category: 'food', tooltipFields: ['satiety', 'exp', 'sellPrice'] },
  cake:   { id: 'cake',   name: '蛋糕',   emoji: '🍰', satiety: 30, exp: 25, sellPrice: 10, category: 'food', tooltipFields: ['satiety', 'exp', 'sellPrice'] },
  fish:   { id: 'fish',   name: '小鱼干', emoji: '🐟', satiety: 25, exp: 20, sellPrice: 8,  category: 'food', tooltipFields: ['satiety', 'exp', 'sellPrice'] },
  milk:   { id: 'milk',   name: '牛奶',   emoji: '🥛', satiety: 15, exp: 10, sellPrice: 3,  category: 'food', tooltipFields: ['satiety', 'exp', 'sellPrice'] },
  cookie: { id: 'cookie', name: '饼干',   emoji: '🍪', satiety: 10, exp: 5,  sellPrice: 2,  category: 'food', tooltipFields: ['satiety', 'exp', 'sellPrice'] },
}
