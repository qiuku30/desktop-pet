...
> 最后更新：2026-07-30（ARCH-11 完成农场完整 Pixi 场景运行时）
> Phase 1、番茄钟、2048、桌宠形象化 Phase 2 与农场首发均已交付；农场视觉升级 Task 1～4（含完整资产与场景运行时）已完成。
...
| 🎨 农场视觉升级 | 完整资产与 snapshot 驱动 Pixi 场景运行时已完成；下一阶段接入正式农场 UI |
| 活动监视 | 设计文档已完成，隐私敏感 |
| 躲避光标 | 搁置，需主进程侧方案 |
...
| 分支 | 状态 | 说明 |
|------|------|------|
| `main` | ✅ 本地稳定，领先远端 | 农场完整资产 `c3725bc`、完整 Pixi 场景运行时 `0d60c0b` 已集成；尚未 push |
