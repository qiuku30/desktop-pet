...
农场经营按六阶段计划推进：farm-01～05 已提交并验收，farm-05 提交为 `33471a0`；farm-06 两项竞态返修后已通过 ARCH-10 第二轮独立复验，当前改动未提交。
...
|------|------|
| 📝 英语单词 | spec 占位，待细化需求 |
| 🌾 农场经营 | ARCH-10 已确认首发需求与架构设计；farm-01～05 已提交验收，farm-06 已通过第二轮独立复验、待用户授权提交 |
| 活动监视 | 设计文档已完成，隐私敏感 |
| 躲避光标 | 搁置，需主进程侧方案 |
