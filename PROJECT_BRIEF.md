...
> 最后更新：2026-07-24（ARCH-08 桌宠形象化设计确认）
> Phase 1、番茄钟和 2048 已交付；桌宠形象化已完成需求与架构设计，待实现。
...
| 📝 英语单词 | spec 占位，待细化需求 |
| 🌾 农场经营 | spec 占位，待细化需求 |
| 桌宠形象化 + 皮肤系统 | ARCH-08 重做并确认设计：奶油星团 + 独立帧协议 + Canvas 渲染，待实现 |
| 活动监视 | 设计文档已完成，隐私敏感 |
| 躲避光标 | 搁置，需主进程侧方案 |
...
桌宠形象化（设计已确认，待实现）、单词（Phase 2）、农场（Phase 2）、超市（待规划）
