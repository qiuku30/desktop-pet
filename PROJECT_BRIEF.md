...
农场经营六阶段均已提交并验收，farm-06 提交为 `564a3b5`；farm-fix-01 已通过 ARCH-10 独立复验，当前等待用户授权提交。
...
|------|------|
| 📝 英语单词 | spec 占位，待细化需求 |
| 🌾 农场经营 | farm-01～06 已提交验收；farm-fix-01 已修复农田面板横排与溢出并通过独立复验，待用户授权提交 |
| 活动监视 | 设计文档已完成，隐私敏感 |
| 躲避光标 | 搁置，需主进程侧方案 |
...
单词（Phase 2）、农场后续阶段（farm-03～06）、超市（待规划）；桌宠形象化的多形态、外部皮肤包和用户照片生成属于长期扩展。
